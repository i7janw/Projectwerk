...
\begin{homeworkProblem}[27/01/2018]
...
\end{itemize}
github : scriptjes COMMIT/PUSH/PULL gemaakt in de directorie Projectwerk.
Hiermee wordt niet alleen de broncode naar github gestuurd, maar ook alle
documenten die geschreven worden.  
\\\\
Vraag use case diagram is nog te bekijken.
\\\\
