...
\item\textbf{Methodes}
	\begin{itemize}
	\item  \textcolor{red}{\textbf{$-$showInit()}} Te bekijken
        \item  \textcolor{red}{\textbf{$-$showCommon()}} Te bekijken
 	\item  \textcolor{red}{\textbf{$-$showSearchOrAansluitpunt(String aansluitpunt, bool search)}} Te bekijken
	...
	\item  \textcolor{blue}{\textbf{$-$showSearch(String search)}}
                \begin{itemize}
                        ...
                        \item \textbf{Parameters} : String search
                        \item \textbf{Return} : niets.
                \end{itemize}
	...
	\item  \textcolor{blue}{\textbf{$-$setUnsaved(bool status)}}
				...
				\end{itemize}
                        \item \textbf{Return} : niets.
                \end{itemize}
	\item  \textcolor{blue}{\textbf{$-$dgvLaagspanningsnet\_SelectionChanged(object sender, EventArgs e)}}
                \begin{itemize}
...
selectiebalk in DataGridView\\ (zie ook: https://stackoverflow.com/questions/11330147/how-to-disable-the-ability-to-select-in-a-datagridview)
	...
	\item \textcolor{blue}{\textbf{$-$txtbxSearch\_KeyDown(object sender, KeyEventArgs e)}}
		\begin{itemize}
