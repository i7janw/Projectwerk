...
%\end{homeworkProblem}
%\newpage
\begin{homeworkProblem}[Werkdocument : klad]
\textbf{Ter info :} Dit is een niet afgewerkt (klad) werkdocument. De grafische voorstelling van
het klassendiagram is terug te vinden op draw.io en zal later in dit
document bijgevoegd worden. Momenteel worden hier de
methodes beschreven die geprogrammeerd moeten worden.  Naargelang er
vooruitgang wordt geboekt, zal dit document aangevuld worden. Als er tijdens
het programmeren blijkt dat er zaken aangepast moeten worden, wordt dit naar
dit document teruggekoppeld.
\\\\
\textbf{Werkwijze :} Eerst wordt er voor een bepaalde \textbf{klasse}
nagedacht over de attributen en methodes en deze in dit document aangevuld.
Pas daarna wordt er gestart met programmeren en eventueel teruggekoppeld als
zaken niet werkbaar blijken.
\end{homeworkProblem}
