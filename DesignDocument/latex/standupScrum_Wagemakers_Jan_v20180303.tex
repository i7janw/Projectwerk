...
\\\\
%\begingroup
%\begin{wrapfigure}{l}{0.15\textwidth} %this figure will be at the right
%    \centering
%    \includegraphics[width=0.15\textwidth]{/home/jan/Afbeeldingen/FAMP.png}
%\end{wrapfigure}
%
%Om te kunnen inschatten hoe het programma werkt als de verbinding over een echt netwerk
%loopt en de Mysql-server niet al te snel is, is er een FAMP (FreeBSD,
%Apache, Mysql, PHP) ge\"installeerd op een alix2D13 (CPU: 500 MHz AMD Geode
%LX800 / RAM: 256 MB DDR DRAM). 
%Vermits de broncode ook op github staat, oppassen dat er geen paswoorden
%gelekt worden. Momenteel kan dit geen kwaad omdat de Mysql-server enkel
