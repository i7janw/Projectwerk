...
\newcommand{\hmwkTitle}{9. Business vereisten} % Assignment title
...
\begin{homeworkProblem}[Business vereisten]
De software zorgt voor de gebruiker dat :
\begin{itemize}
\item op een effici\"ente wijze de gegevens van het laagspanningsnet
opgeslagen worden.
\item deze gegevens eenvoudig aangepast kunnen worden.
\item deze gegevens snel te raadplegen zijn.
\item de gegevens snel te doorzoeken zijn.
\item de gegevens afgedrukt kunnen worden.
\end{itemize}
