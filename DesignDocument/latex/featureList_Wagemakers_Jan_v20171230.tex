	...
	\begin{center}
		\begin{tabular}{ | l | c | c | c | }	\hline
			...
			Gegevens ZekeringKast aanpassen					&  \checkmark	&     ~		&	~		\\ \hline
 		    	% toevoegen waren we vergeten
			HoogspanningsTransfo toevoegen                         		&  \checkmark   &     ~         &       ~               \\ \hline
                        VerdeelBord toevoegen                         			&  \checkmark   &     ~         &       ~               \\ \hline
                        ZekeringKast toevoegen                                 		&  \checkmark   &     ~         &       ~               \\ \hline
			% verwijderen waren we vergeten
			HoogspanningsTransfo verwijderen                                &  \checkmark   &     ~         &       ~               \\ \hline
                        VerdeelBord verwijderen                                         &  \checkmark   &     ~         &       ~               \\ \hline
                        ZekeringKast verwijderen                                        &  \checkmark   &     ~         &       ~               \\ \hline
			% machines waren we vergeten
			Machine toevoegen                                               &  \checkmark   &     ~         &       ~               \\ \hline
			Machine aanpassen                                               &  \checkmark   &     ~         &       ~               \\ \hline
			Machine verwijderen                                             &  ~		& \checkmark    &       ~               \\ \hline
			...
			Lijst tonen van niet aangesloten Machines			&  ~            &     ~         &       \checkmark      \\ \hline
			Lijst tonen van niet aangesloten VerdeelBorden			&  ~            &     ~         &       \checkmark      \\ \hline
			Lijst tonen van niet aangesloten ZekeringKasten			&  ~            &     ~         &       \checkmark      \\ \hline
