...
\newcommand{\hmwkTitle}{6. Use case diagram} % Assignment title
...
\begin{homeworkProblem}[Use case diagram]
\includegraphics[width=1.05\textwidth]{/home/jan/MEGA/2017-2018/ProjectWerk/DesignDocument/1.6_useCaseDiagram/useCaseDiagram.pdf}


%\includepdf[pages=1,pagecommand={\subsection{Kopie des Projektantrages}
%\thispagestyle{empty}}, fitpaper=true]{\antrag}
