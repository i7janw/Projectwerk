...
\newcommand{\hmwkTitle}{14. Rollen} % Assignment title
...
\begin{homeworkProblem}[Rollen]
Het \textit{team} bestaat uit:
\begin{itemize}
\item Product Owner : Hansen Industrial Transmissions
\item Projectleider : Jan Wagemakers
\item Scrummaster : Jan Wagemakers
\item Database analist  : Jan Wagemakers
\item Software analist  : Jan Wagemakers
\item Frontend developer (grafische interface)  : Jan Wagemakers
\item Backend developer : Jan Wagemakers
\item Tester : Jan Wagemakers
\item Beheer documentatie : Jan Wagemakers
\end{itemize}
